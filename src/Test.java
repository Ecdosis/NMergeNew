...
import edu.luc.nmerge.exception.MVDToolException;
import edu.luc.nmerge.exception.MVDTestException;
...
public class Test 
{
	...
	private static void doImportExportTest()
	{
		try
		{
			...
			String mvdName = createTestMVD( testDataFolder );
			File mvdFile = new File( mvdName );
			MVD mvd1 = MVDFile.internalise( mvdFile, null );
			// export it to XML
			...
			MVD mvd2 = MVDFile.internalise( mvdFile, null );
