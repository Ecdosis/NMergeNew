...
public class Arc 
{
	...
	/**
	 * Split an arc into two. This can get complex because arcs may 
     * be children of a transposed parent or the parent itself or just
     * a plain vanilla arc.
	 * @param offset into data pointing to the first byte of the rhs
